    ...
    <section className="py-20 md:py-24" aria-labelledby="preview-heading">
      <div className="mx-auto grid max-w-6xl items-center gap-12 px-5 md:grid-cols-2 md:px-8">
        ...
        <div
          ...
          aria-hidden="true"
        >
          <div className="rounded-[2rem] border border-border bg-surface p-3 shadow-[0_30px_80px_-40px_rgba(13,61,40,0.55)]">
            <div className="overflow-hidden rounded-[1.5rem] bg-[linear-gradient(180deg,#0d3d28_0%,#1b7a4e_55%,#e8f3ec_55%,#ffffff_100%)] px-5 pb-6 pt-8">
              <p className="font-display text-2xl font-semibold text-white">
                {siteConfig.name}
              </p>
              <p className="mt-1 text-sm text-white/70">Today</p>
              <div className="mt-8 rounded-2xl bg-white p-5 text-foreground">
                ...
                <ul className="mt-5 space-y-2 text-sm">
                  ...
                  <li className="flex justify-between border-t border-border pt-2">
                    <span>Lunch</span>
                    <span className="font-medium">680 kcal</span>
                  </li>
                  <li className="flex justify-between border-t border-border pt-2">
                    <span>Dinner</span>
